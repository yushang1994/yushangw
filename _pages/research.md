...
Publications
======
* [Road Infrastructure, Foreign Direct Investment, and Economic Growth in China](https://doi.org/10.1016/j.retrec.2026.101833) [![PDF Link]({{ site.baseurl }}/images/research/pdf.jpeg){:height="20px" width="20px"}]({{ site.baseurl }}/files/pdf/research/FDI_Growth_August_Revision.pdf)
    * <span style="font-size:16px;"> *with [Kaiyi Wen](https://www.kaiyiwen.com/)* </span> <br>
    * <span style="font-size:16px;"> *Research in Transportation Economics*, 119 (2026), 101833 </span> <br>
...
Working papers
======
* High-Speed Rail and Mental Health among Middle-aged and Older Adults in China [![PDF Link]({{ site.baseurl }}/images/research/pdf.jpeg){:height="20px" width="20px"}]({{ site.baseurl }}/files/pdf/research/JMP_YushangWei.pdf) [![Poster Link]({{ site.baseurl }}/images/research/poster.png){:height="20px" width="20px"}]({{ site.baseurl }}/files/pdf/research/JMP_Poster_YushangWei.pdf) (Under Review)
...
* Sensory Pollution and Mental Health: Evidence from Roadway Noise and Nighttime Light [![PDF Link]({{ site.baseurl }}/images/research/pdf.jpeg){:height="20px" width="20px"}]({{ site.baseurl }}/files/pdf/research/Seneroy_Pollution_and_Mental_Health_Jan_2026.pdf) (Submitted)
...
* Rough Waters: Flood Zone Reclassification and Community Stability
    * <span style="font-size:16px;"> *with [Kaiyi Wen](https://www.kaiyiwen.com/) and [Michael Coury](https://www.michaelrcoury.com/home)* </span> <br>
