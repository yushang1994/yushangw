...
* Road Infrastructure in China: Assessing the Impact on Foreign Direct Investment and Economic Growth  [![PDF Link]({{ site.baseurl }}/images/research/pdf.jpeg){:height="20px" width="20px"}]({{ site.baseurl }}/files/pdf/research/FDI_Growth_August_Revision.pdf) (Under Review)
